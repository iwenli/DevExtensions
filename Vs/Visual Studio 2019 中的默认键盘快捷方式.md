...
1. [全局](#jump0)
2. [ADO.NET 实体数据模型设计器](#jump1)
3. [类图](#jump2)
4. [编码的 UI 测试编辑器](#jump3)
5. [数据集编辑器](#jump4)
6. [差异查看器](#jump5)
7. [DOM 资源管理器](#jump6)
8. [F# 交互](#jump7)
...
10. [图形诊断](#jump9)
11. [HTML 编辑器](#jump10)
12. [HTML 编辑器设计视图](#jump11)
13. [HTML 编辑器源视图](#jump12)
14. [层关系图](#jump13)
15. [托管资源编辑器](#jump14)
16. [合并编辑器窗口](#jump15)
17. [Microsoft SQL Server Data Tools，架构比较](#jump16)
18. [Microsoft SQL Server Data Tools，表设计器](#jump17)
19. [Microsoft SQL Server Data Tools，T-SQL 编辑器](#jump18)
20. [Microsoft SQL Server Data Tools，T-SQL PDW 编辑器](#jump19)
21. [Page Inspector](#jump20)
22. [查询设计器](#jump21)
23. [查询结果](#jump22)
24. [报表设计器](#jump23)
25. [序列图](#jump24)
...
38. [VC 字符串编辑器](#jump37)
39. [视图设计器](#jump38)
40. [Visual Studio](#jump39)
41. [Windows Forms Designer — Windows 窗体设计器](#jump40)
42. [工作项编辑器](#jump41)
43. [工作项查询视图](#jump42)
44. [工作项结果视图](#jump43)
45. [工作流设计器](#jump44)
46. [XAML 设计器](#jump45)
47. [XML（文本）编辑器](#jump46)
48. [XML 架构设计器](#jump47)
</details>
...
### <span id = "jump29">文本编辑器</span>
命令|键盘快捷键
--|--
编辑.分行 | Enter `or ` Shift+Enter
编辑.左移字符 | 向左键
编辑.向左扩展一个字符 | Shift+向左键
...
编辑.完成单词 | Ctrl+空格键 `or ` Alt+向右键
编辑.复制参数提示 | Ctrl+Shift+Alt+C
编辑.减少筛选器级别 | Alt+,
编辑.向后删除 | Backspace `or ` Shift+Bkspce
